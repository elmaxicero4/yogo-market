...
?>
  ...
  <div id="tela" style="background-color: #ffffff; height: 100%; width: 100%;">
    ...
    <span class="meu_texto" id="lbl1" style="font-size: 20px; color: #666666; font-weight: bold; ">Crear cuenta</span>
    ...
    <div class="container" id="id_do_container">
      ...
      <div class="container" id="id_do_container1">
        <button type="button" onclick="siguiente()" id='btn_siguiente1' class="btn btn-primary">Siguiente</button>
      </div>
    </div>
  </div>
